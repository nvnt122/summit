export const CONSTANTS = {
  ...
  ENABLE_REDIRECT_FROM_CRM: true,
  ENABLE_REDIRECT_FROM_PD: false,
  ENABLE_SHARE_VIA_WHATS_APP: true,
  ENABLE_SHARE_VIA_EMAIL: true,
  ENABLE_WHATSAPP_INVOICE_FEATURE: true,
  ENABLE_EMAIL_INVOICE_FEATURE: true,
